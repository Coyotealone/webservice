...
class StuffController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('CoyoteApiBundle:Stuff')->findAll();
     ...
     * @Method("POST")
     * @Template("CoyoteApiBundle:Stuff:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('CoyoteApiBundle:Stuff')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("CoyoteApiBundle:Stuff:edit.html.twig")
     */
