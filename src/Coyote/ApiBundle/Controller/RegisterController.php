...
class RegisterController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('CoyoteApiBundle:Register')->findAll();
     ...
     * @Method("POST")
     * @Template("CoyoteApiBundle:Register:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('CoyoteApiBundle:Register')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("CoyoteApiBundle:Register:edit.html.twig")
     */
