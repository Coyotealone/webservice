...
class PersoController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('CoyoteApiBundle:Perso')->findAll();
     ...
     * @Method("POST")
     * @Template("CoyoteApiBundle:Perso:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('CoyoteApiBundle:Perso')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("CoyoteApiBundle:Perso:edit.html.twig")
     */
