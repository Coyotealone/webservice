...
class GuildController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('CoyoteApiBundle:Guild')->findAll();
     ...
     * @Method("POST")
     * @Template("CoyoteApiBundle:Guild:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('CoyoteApiBundle:Guild')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("CoyoteApiBundle:Guild:edit.html.twig")
     */
